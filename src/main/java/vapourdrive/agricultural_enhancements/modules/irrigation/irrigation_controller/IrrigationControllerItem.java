...
//        list.add(Component.literal(df.format(ConfigSettings.FURNACE_BASE_SPEED.get()*100 )+"% speed").withStyle(ChatFormatting.BLUE));
        list.add(Component.translatable("message.agriculturalenhancements.irrigation_controller_1").withStyle(ChatFormatting.BLUE));
        list.add(Component.translatable("message.agriculturalenhancements.irrigation_controller_2").withStyle(ChatFormatting.BLUE));
    }
}
